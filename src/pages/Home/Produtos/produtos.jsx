            ...
            <div className="produtos_itens">
                <div className="prod">
                    ...
                    <p className="desc_prod2">
                        <strong>Camada seca:</strong> Mantém a sensação de frescor por mais tempo.<br /><br />
                        <strong>Super proteção:</strong> Ideal para fluxos intensos, garantindo confiança em qualquer momento do dia.<br /><br />
                        <strong>Abas ajustáveis:</strong> Proporcionam fixação segura e liberdade de movimento.<br /><br />
                ...
                <div className="prod">
                    ...
                    <p className="desc_prod1">Conheça seus benefícios:</p><br />
                    <p className="desc_prod2">
                        <strong>Camada seca:</strong> Garante uma sensação de frescor ao longo do dia, mantendo você protegida.<br /><br />
                        <strong>Alta absorção:</strong> Desenvolvido para fluxos moderados a intensos, oferecendo segurança em todos os momentos.<br /><br />
                        <strong>Sem abas:</strong> Perfeito para quem prefere discrição e liberdade de movimento sem comprometer a proteção.<br /><br />
                ...
                <div className="prod">
                    ...
                    <p className="desc_prod2" id="prod1">
                        <strong>Cobertura extra longa:</strong> Garante proteção completa em qualquer posição.<br /><br />
                        <strong>Alta absorção:</strong> Ideal para fluxos intensos, mantendo a sensação de frescor durante toda a noite.<br /><br />
                        <strong>Conforto superior:</strong> Material macio que respeita a delicadeza da pele.<br /><br />
                ...
                <div className="prod">
                    ...
                    <p className="desc_prod1">Conheça seus benefícios:</p><br />
                    <p className="desc_prod2">
                        <strong>Absorção superior:</strong> Projetado para fluxos moderados, garantindo máxima proteção sem comprometer o conforto.<br /><br />
                        <strong>Discrição e conforto:</strong> Ideal para quem busca uma solução prática e eficaz para o dia a dia.<br /><br />
                        <strong>Tecnologia suave:</strong> Material macio e delicado com a pele, proporcionando uma sensação de bem-estar.<br /><br />
